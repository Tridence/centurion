...
if ( ! function_exists( 'halstein_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function halstein_get_filter_items( $params ) {
		...
		return apply_filters( 'halstein_filter_get_filter_items', $items, $params );
	}
}
