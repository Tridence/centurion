...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'halstein' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'halstein' );
...
?>
	<div class="qodef-quantity-buttons quantity">
		...
		<input
				type="<?php echo esc_attr( apply_filters( 'halstein_filter_woo_quantity_input_type', 'text' ) ); ?>"
				...
				aria-label="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'halstein' ); ?>"
				size="4"
