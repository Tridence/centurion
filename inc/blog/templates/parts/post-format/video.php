<?php if ( ! is_single() ) : ?>
	<?php
	// Include featured image with video icon
	halstein_template_part( 'blog', 'templates/parts/post-info/image', 'icon-video' );
	?>
<?php else : ?>
	<?php
	...
	<?php if ( ! empty( $video_meta ) ) : ?>
		...
		$settings = apply_filters(
			'halstein_filter_video_post_format_settings',
			array(
