...
<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( halstein_get_grid_gutter_classes() ); ?>" role="main">
	<div class="qodef-grid-inner clear">
		...
		echo apply_filters( 'halstein_filter_search_archive_template', halstein_get_template_part( 'search', 'templates/search' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
